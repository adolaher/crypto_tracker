...
r1 = Coin.create!(name: "BTC", picture: "https://bitcoin.org/img/icons/opengraph.png", user: u1)
...
r6 = Coin.create!(name: "TRX", picture: "http://files.coinmarketcap.com.s3-website-us-east-1.amazonaws.com/static/img/coins/200x200/ripple.png", user: u1)
r7 = Coin.create!(name: "XRP", picture: "https://www.cryptocompare.com/media/12318089/trx.png", user: u1)
r8 = Coin.create!(name: "ETC", picture: "http://files.coinmarketcap.com.s3-website-us-east-1.amazonaws.com/static/img/coins/200x200/ethereum-classic.png", user: u1)
r9 = Coin.create!(name: "XMR", picture: "http://files.coinmarketcap.com.s3-website-us-east-1.amazonaws.com/static/img/coins/200x200/monero.png", user: u1)
r10 = Coin.create!(name: "DASH", picture: "http://files.coinmarketcap.com.s3-website-us-east-1.amazonaws.com/static/img/coins/200x200/dash.png", user: u1)
r11 = Coin.create!(name: "DOGE", picture: "http://files.coinmarketcap.com.s3-website-us-east-1.amazonaws.com/static/img/coins/200x200/dogecoin.png", user: u1)
r12 = Coin.create!(name: "BCH", picture: "http://files.coinmarketcap.com.s3-website-us-east-1.amazonaws.com/static/img/coins/200x200/bitcoin-cash.png", user: u1)
...
comment4= Comment.create!(title: "Slow but steady", rating: "5", body:"Solid investment backed by good technology", date: "2017-10-10", initial_coin_deposit: "1", coin_id: r2.id, user_id: u2.id)
